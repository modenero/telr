const initOrderBook = async  () => {
    ...
    /* Initialize endpoint. */
    const endpoint = `https://db-ropsten.telr.exchange/v1/getAddress/${dataId}`
     ...
     * -----------------
     *
     * 1. BAI / WETH      Wrapped Ethereum
     *                      0x00a021b22099e4cd759b5f5b73556ef143c9df7cac23530968e0f9130c47fb1f ROPSTEN
     * 2. BAI / DAI       MakerDAO DAI
     * 3. BAI / 0xBTC     0xBitcoin Token
     * 4. BAI / WBTC      Wrapped Bitcoin
     */
