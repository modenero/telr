const connectMetamask = async () => {
    ...
    let anameTelr = '0x565d0859a620aE99052Cc44dDe74b199F13A3433'
    let ttl = 5200000

    const contract = { t: 'address', v: anameTelr }
    ...
    const sigHash = web3.utils.soliditySha3(
        contract, // Telr's contract address
    ...
    if (false) { // MAINNET
        ...
        // endpoint = 'https://cache.telr.exchange/v1'
    } else { // ROPSTEN
        endpoint = 'http://localhost:4000/v1'
        // endpoint = 'https://cache-ropsten.telr.exchange/v1'
    }
    ...
    const eth = await ethereum.enable()
        .catch(_error => {
            ...
            if (
                ...
                alert('Please refresh to Authorize Telr access to your Wallet.')
            }
        })
    ...
    const msgParams = [{
        ...
        type: 'string',
        name: 'Telr Summary',
        value: `I want $13.3723 worth of BCH` +
               `\nI am offering 561.8613 BAI` +
